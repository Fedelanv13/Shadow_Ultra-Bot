...
*°.⎯⃘̶⎯̸⎯ܴ⎯̶᳞͇ࠝ⎯⃘̶⎯̸⎯ܴ⎯̶᳞͇ࠝ⎯⃘̶⎯̸.°*
 ...
 if (command === 'play' || command === 'mp3'  || command === 'playaudio') {
...
} else if (command === 'play2' || command === 'mp4x' || command === 'playvideo') {
  try {
  ...
  return conn.reply(m.chat, '⚠︎ Comando no reconocido.', m);
    ...
    user.chocolates -= 0;
    conn.reply(m.chat, `ꕥ Video enviado 📤  Con éxito 🍫*`, m);
...
handler.command = handler.help = ['play2', 'mp4x', 'playvideo'];
