...
let handler = async (m, { conn, text }) => {
  ...
  try {
    ...
    await conn.sendMessage(m.chat, { text: "*🎧 Accediendo a la carpeta de musica 👻*\n ```🔍 Espera un momento busco tu rola audio XD``` _No te me desesperes_ ;>", react: { text: "😜", key: m.key } });
